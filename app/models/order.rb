class Order < ApplicationRecord
  ...
  scope :infor_order, ->{select :id, :name, :phone, :address, :email,
    :all_product, :created_at}

  def add_amount_price all_product, all_price
    Order.create(all_product: all_product, all_price: all_price)
  end
